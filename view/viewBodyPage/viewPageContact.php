    ...
    <form action="./index.php?callPage=sendMessageFormContact" method="post" class="col-lg-6">
      <h4>Formulaire de contact :</h4><br/>
				<div class="form-group">
				 <input type="text" class="form-control" id="name" name="name" placeholder="Nom ( 25 caractères maximum )" required >
			  </div>
				<div class="form-group">
					<input type="text" class="form-control" id="email" name="email" placeholder="Email ( ex: xxxxx@xxx.xx )" required >
			 	</div>
        <div class="form-group">
